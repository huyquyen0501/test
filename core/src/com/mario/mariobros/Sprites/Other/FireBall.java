package com.mario.mariobros.Sprites.Other;
...
public class FireBall extends Sprite {
    ...
    public FireBall(PlayScreen screen, float x, float y, boolean fireRight){
        ...
        setRegion((Texture) fireAnimation.getKeyFrame(0));//chu y thang nay
    ...
    public void update(float dt){
        stateTime += dt;
        setRegion((Texture) fireAnimation.getKeyFrame(stateTime, true));////chu y thang nay
