package com.mario.mariobros.Sprites;
...
import com.mario.mariobros.Screens.PlayScreen;
import com.mario.mariobros.Sprites.Enemies.Enemy;
import com.mario.mariobros.Sprites.Enemies.Turtle;
import com.mario.mariobros.Sprites.Other.FireBall;
    ...
    public TextureRegion getFrame(float dt){
        ...
        switch(currentState){
            case DEAD:
                ...
                break;
            case GROWING:
                region = (TextureRegion) growMario.getKeyFrame(stateTimer);//chu y thang nay
            ...
            case JUMPING:
                ...
                break;
            case RUNNING:
                region = (TextureRegion) (marioIsBig ? bigMarioRun.getKeyFrame(stateTimer, true) : marioRun.getKeyFrame(stateTimer, true));//chu y thang nay
                break;
            case FALLING:
            case STANDING:
            default:
